                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="card hover-y">
                            <a href="{{URL::to('listings/'.$listing->listing_slug.'/'.$listing->id)}}" class="card-image" title="{{$listing->title}}">
                                ...
                                <div class="list-tag-badge"><span class="fal {{\App\Models\Categories::getCategoryInfo($listing->cat_id)->category_icon}} icon-element icon-element-sm"></span> {{\App\Models\Categories::getCategoryInfo($listing->cat_id)->category_name}} - {{\App\Models\SubCategories::getSubCategoryInfo($listing->sub_cat_id)->sub_category_name}}</div>
                            </a>
