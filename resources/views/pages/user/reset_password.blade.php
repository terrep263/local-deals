...
@section('hero_title', trans('words.reset_password'))
@section('hero_breadcrumbs', json_encode([['label' => trans('words.home'), 'url' => '/'], ['label' => trans('words.reset_password'), 'url' => '']]))

@section('content')

@include('common.page-hero-header', ['title' => trans('words.reset_password')])  
    ...
    <div class="container">
        <div class="col-lg-5 mx-auto p-0">
                ...
                @endif
                 ...
                 <form action="{{ url('password/reset') }}" class="card mb-0" id="forget_pass_form" role="form" method="POST"> 
                     @csrf 
