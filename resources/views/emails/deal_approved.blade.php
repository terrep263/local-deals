...
<table border="0" cellpadding="0" cellspacing="0" width="60%" style="margin:0 auto;border:1px solid rgba(0, 0, 0, 0.2);padding:20px;">
 ...
 <tr>
  <td style="padding: 20px 0 30px 0;line-height:22px;">
    ...
    <p>Great news! Your deal "<strong><?php echo $deal->title ?></strong>" has been approved and is now live!</p>
    <p>Consumers can now view and purchase your deal. Share it with your customers to maximize sales!</p>
    <p><a href="{{ url('/deals/' . $deal->slug) }}" style="background: #28a745; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin-top: 10px;">View Deal</a></p>
  </td>
 </tr>
