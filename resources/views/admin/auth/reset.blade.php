...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    ...
    <span aria-hidden="true">&times;</span></button>
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                <form action="{{ url('admin/password/reset') }}" class="" id="passwordform" role="form" method="POST">
                                    @csrf
                                ...
                                <div class="form-group">
                                            <button class="btn btn-block btn-primary" type="submit"><i class="si si-lock-open pull-right"></i> Reset Password</button>
                                </div>
