                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12">
                            ...
                            <span aria-hidden="true">&times;</span></button>
                                ...
                                <form action="{{ url('admin/payment_gateway/razorpay') }}" class="form-horizontal padding-15" name="category_form" id="category_form" role="form" method="POST" enctype="multipart/form-data">  
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Razorpay Key ID</label>
                                          <div class="col-sm-9">
                                            <input type="text" name="razorpay_key" value="{{ old('razorpay_key', $gateway_info->razorpay_key ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="razorpay_secret" value="{{ old('razorpay_secret', $gateway_info->razorpay_secret ?? '') }}" class="form-control">
                                        </div>
                                    </div>
