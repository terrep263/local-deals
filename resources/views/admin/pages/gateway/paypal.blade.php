                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12">
                            ...
                            <span aria-hidden="true">&times;</span></button>
                                ...
                                <form action="{{ url('admin/payment_gateway/paypal') }}" class="form-horizontal padding-15" name="category_form" id="category_form" role="form" method="POST" enctype="multipart/form-data">  
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            @php($selectedMode = old('mode', $gateway_info->mode ?? 'sandbox'))
                                            <select id="basic" name="mode" class="js-select2 form-control">
                                                 
                                                <option value="sandbox" @selected($selectedMode === 'sandbox')>Sandbox</option>
                                                <option value="live" @selected($selectedMode === 'live')>Live</option>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Paypal Cient ID</label>
                                          <div class="col-sm-9">
                                            <input type="text" name="paypal_client_id" value="{{ old('paypal_client_id', $gateway_info->paypal_client_id ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="paypal_secret" value="{{ old('paypal_secret', $gateway_info->paypal_secret ?? '') }}" class="form-control">
                                        </div>
                                    </div>
