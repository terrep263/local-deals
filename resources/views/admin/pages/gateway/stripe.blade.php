                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12">
                            ...
                            <span aria-hidden="true">&times;</span></button>
                                ...
                                <form action="{{ url('admin/payment_gateway/stripe') }}" class="form-horizontal padding-15" name="category_form" id="category_form" role="form" method="POST" enctype="multipart/form-data">  
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Stripe Secret Key</label>
                                          <div class="col-sm-9">
                                            <input type="text" name="stripe_secret_key" value="{{ old('stripe_secret_key', $gateway_info->stripe_secret_key ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="stripe_publishable_key" value="{{ old('stripe_publishable_key', $gateway_info->stripe_publishable_key ?? '') }}" class="form-control">
                                        </div>
                                    </div>
