...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        @if(request()->segment(3)=='addcategory') 

         <script type='text/javascript' src="{{ URL::asset('admin_assets/js/simple-iconpicker.min.js') }}"></script>

         <script>
            var whichInput = 0;

            $(document).ready(function(){
              $('#select_icon_id').iconpicker("#select_icon_id");
             });
        </script>
        @endif
        ...
        <script>
           $(function(){
            ...
            $('#listing_status').on('change', function () {
                  var url = $(this).val(); // get selected value
...
$('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
    ...
    //document.title = $(this).text()+" | Admin";
  });
