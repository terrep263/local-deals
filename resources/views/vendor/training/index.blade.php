...
@section('hero_title', 'Vendor Training')
@section('hero_breadcrumbs', json_encode([['label' => trans('words.home'), 'url' => '/'], ['label' => 'Training', 'url' => '']]))

@section("content")

@include('common.page-hero-header', ['title' => 'Vendor Training']) 
